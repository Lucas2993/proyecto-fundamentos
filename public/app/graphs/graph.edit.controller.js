(function() {
    ...
    angular.module('app').controller(controllerName, ['$scope', 'dialogs', 'toastr', 'graphService', 'utils', '$routeParams', editGraph]);

    /**
     * Controlador de la pantalla de edicion de grafo.
     */
    function editGraph($scope, dialogs, logger, graphSrv, utils, params) {
